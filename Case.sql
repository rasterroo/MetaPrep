 ...
 */
 ...
 SELECT 100.0*AVG(CASE WHEN s.transaction_date=p.start_date OR s.transaction_date=p.end_date THEN 1 ELSE 0 END) pct_of_transactions_on_first_or_last_day_of_valid_promotion
 FROM sales s
 JOIN promotions p
